...
final class IamportPaymentViewModel: InputOutputViewModelProtocol {
	...
	private var isIamportAppear = false
	...
	struct Output {
		let outputViewDidAppear: Driver<IamportPayment>
	...
	func transform(input: Input) -> Output {
		...
		return Output(outputViewDidAppear: outputViewDidAppear.asDriver(onErrorJustReturn: createPaymentData()),
